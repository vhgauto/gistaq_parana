...
leaflet::leaflet() |> # <2>
  ...
  leaflet::addPolygons( # <3>
    data = v, color = "#007E2E", stroke = 2, fillColor = "transparent" # <3>
  ) |> # <3>
...
```{r}
unzip(zipfile = "producto/producto.zip", exdir = "producto/") # <1>
...
r10m <- list.files(glue("{carpeta3}/R10m"), full.names = TRUE) # <3>
r20m <- list.files(glue("{carpeta3}/R20m"), full.names = TRUE) # <3>

bandas_nombres <- c( # <4>
  "B01", "B02", "B03", "B04", "B05", "B06", "B07", "B08", "B8A", # <4>
  "B11", "B12" # <4>
) # <4>
...
lista_recortes$B01 <- project(lista_recortes$B01, lista_recortes$B02) # <10>
lista_recortes$B05 <- project(lista_recortes$B05, lista_recortes$B02) # <10>
lista_recortes$B06 <- project(lista_recortes$B06, lista_recortes$B02) # <10>
lista_recortes$B07 <- project(lista_recortes$B07, lista_recortes$B02) # <10>
lista_recortes$B8A <- project(lista_recortes$B8A, lista_recortes$B02) # <10>
lista_recortes$B11 <- project(lista_recortes$B11, lista_recortes$B02) # <10>
lista_recortes$B12 <- project(lista_recortes$B12, lista_recortes$B02) # <10>
...
raster_prob <- terra::rast(glue("{carpeta4}/MSK_CLDPRB_20m.jp2")) # <3>
...
if (nrow(coord_sitios) != nrow(coord_sf_sin_nubes)) {
  ...
  print( # <7>
    glue("Los sitios {puntos_nubes} presentan nubes y se descartan") # <7>
  ) # <7>
}
```
