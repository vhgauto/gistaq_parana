...
Los datos se dividen en dos grupos de acuerdo al formato en el que se presentan, lo cual determina los paquetes requeridos y las operaciones necesarias para operar con estos.
...
datos <- readxl::read_xlsx(
    ...
    select(# <1>
      fecha = 1, longitud = 4, latitud = 5, ph = 6, cond = 8, secchi = 10,# <1>
