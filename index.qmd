...
El río Paraná es el segundo río más largo de América del Sur, con 4000 km [15]. En Argentina, es el límite natural de múltiples provincias, hasta llegar al Río de la Plata, para terminar en el Océano Atlántico. El río Paraguay, con 2550 km [15], es un afluente del río Paraná, en su cuenca media, en el Noreste argentino. La alta presencia de sólidos en el río Paraguay que se descargan en el río Paraná, cambia las características de la composición de este último, creando dos regiones distintas de alta (oeste) y baja (este) concentración de sedimentos [16].
