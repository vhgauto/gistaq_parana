...
source("scripts_quarto/mapa_interactivo_index3.R")
source("scripts_quarto/tabla_corr_lab2.R")
source("scripts_quarto/tabla_corr_gis2.R")
source("scripts_quarto/tabla_banda_S2MSI.R")
source("scripts_quarto/evolucion_lab.R")
source("scripts_quarto/evolucion_gis.R")
source("scripts_quarto/fechas_adq.R")
source("scripts_quarto/corr_identidad_lab_param.R")
```
