...
::: {.callout-note title="Contenido" collapse=true}
...
```{r}
#| label: tbl-adq
#| tbl-cap: <span style='color:`r c2`;'>Fecha actual</span> y de los próximos 10 muestreos.

tabla_adquisicion
```

::: {.callout-note title="Metodología de muestreo" collapse=true}
...
<!-- Coeficientes de correlación lineal de Pearson (<b>R</b>) entre reflectancias de superficie de las bandas espectrales (@tbl-s2msi) de S2-MSI. -->
...
<br>
Las curvas <b style='color:`r c1`'>color azul</b> corresponden a los sitios cercanos a la orilla chaqueña. Los puntos cercanos a la costa correntina son de <b style='color:`r c2`'>color rojo</b>.
...
Se eligieron tres propiedades: turbidez, sólidos suspendidos y profundidad de disco de Secchi.

A continuación se muestran las ecuaciones para la estimación de las propiedades, los sensores y longitudes de onda empleados, las características de los cuerpos de agua y la justificación de los autores.

## Turbidez

Polinomio para estimar turbidez a partir del cociente de bandas S2-MSI B02 y B03 @Ouma2020.

$$
y = 367.82x^{2} − 976.42x + 649.13
$$
$$
x = B02/B03
$$

Ecuaciones para Landsat 8 OLI @Shen2021.

$$
y = 535.137 − 1517.783x + (1078.271x^{2})
$$
$$
x = B04/B03
$$
...
::: {.callout-note title="Objetivos específicos" collapse=true}
...
El desarrollo de algoritmos empíricos requiere de datos espectrales y fisicoquímicos del agua, la propuesta de mode los candidatos, la selección final de los mode los y la validación de los mismos. Luego, la generación de mapas para evaluar la distribución espacial de las propiedades.
