...
El río Paraná es el segundo río más largo de América del Sur, con 4000 km [15]. En Argentina, es el límite natural de múltiples provincias, hasta llegar al Río de la Plata, para terminar en el Océano Atlántico. El río Paraguay, con 2550 km [15], es un afluente del río Paraná, en su cuenca media, en el Noreste argentino. La alta concentración de sedimentos en el río Paraguay que se descargan en el río Paraná, cambia las características de la composición de este último, creando dos regiones distintas de alta (oeste) y baja (este) concentración de sedimentos [16].



El Paraná tiene un gran impacto en la sociedad del AMGR, específicamente sobre la industria pesquera, el turismo, las actividades recreativas de la población local y las rutas de transporte [18]. Es la fuente principal de agua para la planta potabilizadora de la provincia. Dicha planta posee dos tomas de agua cruda ubicada en distintos sectores del mencionado río. Una de ellas, la más antigua, está construida sobre un brazo del río Paraná, el río Barranqueras; éste, a su vez, está conectado con dos ríos principales del AMGR que son los ríos Negro y Tragadero. A fines del 2023, entró en operaciones la nueva toma situada sobre el canal principal de navegación del río Paraná, en una zona cercana al puente Gral. Belgrano, que une las provincias de Chaco y Corrientes.
