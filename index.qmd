...
flowchart LR
    a1([Muestreo de agua])-->a2[Mediciones in-situ y<br>en laboratorio]
    a2-->a3([Propiedades fisicoquímicas])

    b1([Producto S2-MSI L2A])-->b2[Extracción de R<sub>rs</sub>]
    b2-->b3([Firma espectral])

    %% a3--> |<i>turb, cond<br>susp, secchi<br></i>pH| E((Combinación<br>de datos))
    %% b3--> |B01~B8A,<br>B11, B12| E

    a3--> E((Combinación<br>de datos))
    b3--> E
