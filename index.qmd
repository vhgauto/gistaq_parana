...
Dada la gran variabilidad en la cantidad de sedimentos presentes en el agua, la empresa necesita adaptar frecuentemente su proceso de potabilización para asegurar la remoción de éstos. El monitoreo satelital y la comprensión de la distribución espacial de la turbidez del agua en el río Paraná, son insumos valiosos para dicha empresa ya que pueden brindar herramientas fundamentales en la toma de decisiones. La aplicación de la teledetección, en la recuperación de los datos espectrales del agua, mencionados previamente, tiene como objetivo crear un modelo que los estime, de forma remota.  
