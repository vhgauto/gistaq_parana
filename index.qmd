...
In situ, se miden pH, conductividad y profundidad de disco de Secchi. Luego, en el laboratorio se analizan turbidez y sólidos suspendidos. A continuación se describe cada parámetro fisicoquímico:

* pH y conductividad (μS/cm), a partir de un equipo multiparamétrico.

* SSD ó profundidad de disco de Secchi (cm).

* TSM ó sólidos suspendidos totales (ppm) por gravimetría, utilizando el método 2540 D - sólidos totales en suspensión secados a 103-105°C del Standard Methods (APHA, AWWA, WPCF, 2017, p.2-70) -, que emplea filtros de fibra de vidrio de 47 mm de diámetro y 0,5 μm de poro.
