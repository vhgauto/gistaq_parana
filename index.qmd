...
## Sól. susp. vs Cond. Propongo TSM vs Cond.

![](figuras/cond_vs_sol_sus.png)

## SDD vs Sól. susp. Propongo SDD vs TSM
...
## Sól. susp. vs Turb. Propongo TSM vs Turb.
...
Propongo otra redacción para no repetir la palabra define: una definición más rigurosa indica que la reflectancia de sensado remoto se expresa como el cociente entra la... 
$$
