...
A continuación, se describen las funciones objetivo, que en la figura anterior ([figura -@fig-visnetwork]) se muestran como círculos (`r icono_circulo`).
...
Se establecen las coordenadas de la región de interés (-58° 48' 48<b>S</b>, 27° 29' 18<b>O</b>), la fecha ([-@sec-fecha-descarga]) y el nivel de procesamiento.
...
Las funciones se muestran como triángulos (`r icono_triangulo`) en el
([grafo -@fig-visnetwork]).
...
Tabla de coeficientes de correlación lineal <b>R</b> (Pearson) entre pares de parámetros fisicoquímicos, y los valores se acomodan como una matriz triangular para evitar repeticiones.

```{r corr_laboratorio}
#| label: tbl-corr-lab
#| tbl-cap: <br>✦ = p-valor < 0,05<br><b style='color:#E41A1C;'>R</b> = |<b>R</b>| > 0,5
#| tbl-cap-location: margin
...
Coeficientes de correlación lineal de Pearson (<b>R</b>) entre reflectancias de superficie de las bandas espectrales (tabla [-@tbl-s2msi]) de S2-MSI.
