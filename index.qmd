...
::: {.column-screen-right}
![Distribución de R<sub>rs</sub> a partir de gráficos de cajas por sitio fijo (ver figura [-@fig-roi]) y banda espectral.](figuras/puntos_boxplot.png){#fig-boxplot-puntos}
:::
