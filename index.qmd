...
Asimismo, es posible trazar una transecta que atravieze transversalmente el río Paraná para identificar el cambio en R<sub>rs</sub> por banda espectral.

Para ello se define un punto fijo cercano a la costa chaqueña, y se mide la distancia hacia la costa correntina.
