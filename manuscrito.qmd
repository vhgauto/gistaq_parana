...
![Workflow de trabajo](extras/workflow.png){#fig-workflow}
...
* *susp*, Sólidos suspendidos totales (ppm)
* *cond*, Conductividad (&micro;S/cm)
::::
...
<br>
Actualmente, se realizaron **`r cantidad_fechas` muestreos**, en los que se recolectaron **`r cantidad_muetras` muestras de agua**.
...
Evolución espacial y temporal de las propiededes del agua.
...
::: {#fig-prop-fisico}
![](figuras/datos_fisicoquimicos.png){width="50%" fig-align="center"}
:::
...
![Mapa de calor de las correlaciones lineales entre parámetros fisicoquímicos. Con &#9733; se indica significancia estadística ($pvalor<0,05$)](figuras/r.png){width="50%" fig-align="center" #fig-heatmap-lab}
...
::: {#fig-identidad}
![](figuras/identidad_cond_vs_turb.png){width="50%" fig-align="center"}
...
::: {#fig-boxplot-lado}
![ &#9733; $=pvalor<0.05$, existe diferencia significativa entre los grupos](figuras/lado_turb.png){width="50%" fig-align="center"}
:::
...
::: {#fig-firma-espectral}
![](figuras/firma_espectral.png){width="50%" fig-align="center"}
...
:::: {.content-visible when-format="typst"}
![Distribución de $R_{rs}$ a partir de gráficos de cajas por sitio fijo y banda espectral. [&#9733;]{style='color: `{r} c1`'} en la esquina de cada panel marca diferencia significativa ($pvalor<0.05$) entre los conjuntos de la costa [**chaqueña**]{style='color: `{r} c1`'} y [**correntina**]{style='color: `{r} c2`'}.](figuras/puntos_boxplot.png){#fig-boxplot-puntos width="50%" fig-align="center"}
::::
...
::: {.block stroke='rgb("#2780E3")' inset="8pt" radius="4pt"}
