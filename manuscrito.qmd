...
```{r firma_espectral7}
lista_firma_espectral[[7]]
```

## `{r} fechas_gis_v[8]`

```{r firma_espectral8}
lista_firma_espectral[[8]]
```
...
La estimación de los parámetros fisicoquímicos se llevó a cabo mediante el desarrollo de algoritmos de regresión por mecanismos de aprendizaje automático.

Se indican a continuación los resultados de los algoritmos obtenidos para turbidez, profundidad de disco de Secchi y sólidos disueltos.
...
El modelo desarrollado para la estimación de turbidez en el agua del río Paraná fue XGBoost. Los hiperparámetros fueron optimizados con búsqueda bayesiana inteligente.

La figura [-@fig-algoritmo-turb] muestra la turbidez estimada y medida. Las métricas de desempeño dieron: $R^{2}=0,92$ y $RMSE=11,282 NTU$.

::: {#fig-algoritmo-turb}

![](extras/est_vs_pred_turb.png){fig-align="center"}

Estimaciones y mediciones de turbidez del modelo seleccionado.
:::

La distribución espacial de turbidez en el río Paraná se muestra en la figura [-@fig-mapa-turb].

:::: {.column-body-outset-right}

::: {#fig-mapa-turb}

![](extras/mapa_turb.png){fig-align="center"}

Máscara de agua y mapa de turbidez correspondiente al 2025-06-09.
:::

::::

El desarrollo del algoritmo, su optimización y más detalles se encuentran en el [siguiente enlace](https://gomezvictoriq.github.io/Turbidez/).
...
Las estimaciones de transparencia del agua se lograron con un algoritmo de aprendizaje automático XGBoost. El mismo presentó $R^{2}=0,8636$ y $RMSE=231,55 cm$.

La comparación entre profundidad de disco de Secchi estimado y medido puede observarse en la figura [-@fig-algoritmo-secchi].

::: {#fig-algoritmo-secchi}

![](extras/est_vs_pred_secchi.png){fig-align="center"}

Estimaciones y mediciones de profundidad de disco de Secchi del modelo seleccionado.
:::

Para más información respecto del algoritmo desarrollado, dirigirse al siguiente [link](https://mauri491.quarto.pub/estimacion-secchi/).

## Sólidos suspendidos totales<span style="font-weight:normal; font-size: 1rem">, por Ariadna Seba [{{< fa brands github >}}](https://github.com/AriadnaSeba)</span> {toc-text="Sólidos suspendidos totales"}

El modelo que presentó los mejores resultados fue *random forest*.

La concentración de sólidos mostró la siguiente distribución espacial de la figura [-@fig-mapa-sol].

:::: {.column-body-outset-right}

::: {#fig-mapa-sol}

![](extras/mapa_sol.png){fig-align="center"}

Mapa de sólidos disueltos correspondiente al 2025-06-09.
:::

::::

El desarrollo completo del algoritmo se encutran en el [siguiente sitio](https://ariadnaseba.github.io/solidos_suspendidos/).
...
* **Enid Utgés** [{{< fa brands github >}}](https://github.com/Enid2802)
* **Daniela Tenev**
* **Víctor Gauto** [{{< fa brands github >}}](https://github.com/vhgauto)

Becarios:

* **Mauricio Acosta** [{{< fa brands github >}}](https://github.com/mauri491)
* **Vera Geneyer** [{{< fa brands github >}}](https://github.com/VeraGeneyer)
* **Víctor Gómez** [{{< fa brands github >}}](https://github.com/gomezvictoriq)
* **Bruno Lossada Dusset** [{{< fa brands github >}}](https://github.com/BrunoLossada)
* **Ariadna Seba** [{{< fa brands github >}}](https://github.com/AriadnaSeba)
* **Noelia Molo**
...
* **Enid Utgés** [[&#xe709;]{style="font-family: JetBrains Mono; color: `r c1`"}](https://github.com/Enid2802)
* **Daniela Tenev**
* **Víctor Gauto** [[&#xe709;]{style="font-family: JetBrains Mono; color: `r c1`"}](https://github.com/vhgauto)

Becarios:

* **Mauricio Acosta** [[&#xe709;]{style="font-family: JetBrains Mono; color: `r c1`"}](https://github.com/mauri491)
* **Vera Geneyer** [[&#xe709;]{style="font-family: JetBrains Mono; color: `r c1`"}](https://github.com/VeraGeneyer)
* **Víctor Gómez** [[&#xe709;]{style="font-family: JetBrains Mono; color: `r c1`"}](https://github.com/gomezvictoriq)
* **Bruno Lossada Dusset** [[&#xe709;]{style="font-family: JetBrains Mono; color: `r c1`"}](https://github.com/BrunoLossada)
* **Ariadna Seba** [[&#xe709;]{style="font-family: JetBrains Mono; color: `r c1`"}](https://github.com/AriadnaSeba)
* **Noelia Molo**
