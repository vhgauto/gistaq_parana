...
![Flujo de trabajo.](figuras_typst/workflow.png){#fig-workflow width="70%"}
...
![Mapa de los sitios de toma de muestra y propiedades fisicoquímicas.](figuras_typst/mapa_interactivo.png){width="70%"}
...
::: {#fig-prop-fisico}
![Evolución espacial y temporal de las propiedades del agua.](figuras_typst/datos_fisicoquimicos.png){width="50%" fig-align="center"}
:::
...
::: {#fig-boxplot-lado}
![ &#9733; $=pvalor<0.05$, existe diferencia significativa entre los grupos](figuras_typst/lado_cond.png){width="50%" fig-align="center"}
:::
